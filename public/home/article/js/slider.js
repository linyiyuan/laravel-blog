(function($) {
    ...
    $.fn.pbTouchSlider = function(options) {
        ...
        pbSlider.slider_NavArrows ='<ul class="o-slider-arrows"><li class="o-slider-prev" style="background:rgba(0, 0, 0, 0.4);"><i class="icon-left-open-big"></i></li><li class="o-slider-next" style="background:rgba(0, 0, 0, 0.4);"><i class="icon-right-open-big"></i></li></ul>';
